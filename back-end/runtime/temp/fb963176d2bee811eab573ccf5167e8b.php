<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Administrator\Desktop\myminishop\public/../application/admin\view\index\index.html";i:1548749629;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>糯米巴巴微信小程序商城后台管理</title>
    <meta name="keywords" content="糯米巴巴微信小程序商城后台管理">
    <meta name="description" content="糯米巴巴微信小程序商城后台管理">
    <!--[if lt IE 9]>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="/public/static/admin/img/profile_small.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">糯米巴巴Admin</strong></span>
                                <span class="text-muted text-xs block">超级管理员<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<?php echo url('index/info'); ?>">个人资料</a>
                                </li>
                                <li class="divider"></li>
                    ...
                    <li>
                        <a class="J_menuItem" href="<?php echo url('order/index'); ?>"><i class="fa fa-tasks"></i> <span class="nav-label">订单管理</span></a>
                    </li>
                    <li class="menu"> <a href="#">
                        ...
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li> <a class="J_menuItem" href="<?php echo url('user/index'); ?>" data-index="0">用户管理</a> </li>
                            <li> <a class="J_menuItem" href="<?php echo url('address/index'); ?>" data-index="1">地址管理</a> </li>
                            <li> <a class="J_menuItem" href="<?php echo url('goods_collect/index'); ?>" data-index="2">商品收藏</a> </li>
                            <li> <a class="J_menuItem" href="<?php echo url('cart/index'); ?>" data-index="3">购物车管理</a> </li>
                        </ul>
                    </li>
                    <li>
...
<!--                         <li class="hidden-xs">
                            <a href="http://www.studyfox.cn/258.html" target="_blank" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                        </li> -->
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2018 <a href="http://www.studyfox.cn/" target="_blank">StudyFox.cn</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="/public/static/admin/js/hplus.min.js?v=4.1.0"></script>
    <script src="/public/static/admin/js/contabs.min.js" type="text/javascript"></script>
