<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"C:\Users\Administrator\Desktop\myminishop\public/../application/admin\view\category\index.html";i:1518582832;}*/ ?>
<!DOCTYPE html>
<html>
                                            ...
                                            <tbody>
                                                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <td><?php if($vo['img'] != ''): ?><img src="/public/uploads/<?php echo $vo['img']; ?>" alt="<?php echo $vo['name']; ?>" width="36"><?php endif; ?></td>
