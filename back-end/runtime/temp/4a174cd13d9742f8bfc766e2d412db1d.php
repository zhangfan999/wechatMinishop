<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\Users\Administrator\Desktop\myminishop\public/../application/admin\view\order\index.html";i:1520076180;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        $(document).ready(function() {
            $("#dataTables-example").on('click', 'a.goods', function(){
                ...
                layer.open({
                    ...
                    maxmin:true,
                    shade:0.1,
                    content: "<?php echo url('/admin/order/orderGoods/id/"+id+"'); ?>"
                });
            });
            ...
            $("#dataTables-example").on('click', 'a.change_order_status', function(){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url:"<?php echo url('changeOrderStatus'); ?>",
                    data:{'id':id},
